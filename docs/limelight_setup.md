...
| Ethernet cable | Connect to radio or a dedicated switch on the robot |
...
2. Open a browser and navigate to `http://10.103.80.11:5801` (default Limelight
   address – change if needed via the Limelight web interface).
